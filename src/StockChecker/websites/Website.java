...
public abstract class Website {
    ...
    Website(String url) {
        this.url = url;
        this.httpConn = Jsoup.connect(url).userAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.152 Safari/537.36").timeout(40000);
    ...
    Document getDoc() throws SocketTimeoutException {   //Get webpage content
        ...
        try {
            doc = this.httpConn.userAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.152 Safari/537.36").get();
